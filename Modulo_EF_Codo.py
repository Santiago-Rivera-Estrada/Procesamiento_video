...
class Detector_Pose():
    ...
    def __init__(self, mode=False, smooth=True, confianza_dete=0.5, confianza_segui=0.5):
        ...
        )  # Crear un objeto de la clase Pose con los atributos de la clase como argumentos. El modelo de complejidad indica el nivel de detalle de la pose, siendo 0 el más simple y 2 el más complejo. Por defecto se usa el nivel 1 para el video y el nivel 0 para la imagen estática
